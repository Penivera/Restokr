...
class Settings(BaseSettings):
    ...
    DESCRIPTION: str = Field(default="Hyper-local restocking platform - Early Access signup system")
    ...
    # Phone Validation
    DEFAULT_COUNTRY_CODE: str = Field(default="+234", description="Nigeria country code")
